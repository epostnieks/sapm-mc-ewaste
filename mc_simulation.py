#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — E-Waste Export / Basel Convention Evasion
=========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: E-Waste Export (Basel Convention Evasion).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "ewaste",
    "domain_name": "E-Waste Export",
    "theorem": "Basel Convention Evasion",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 1050.0,
    "channels": {
        "C1_planned_obsolescence": {
            ...
            "high": 4500,
            "weight": 0.3,
            "description": "Deadweight loss from designed-in obsolescence"
        },
        "C2_toxic_health": {
            "dist": "lognormal",
            "low": 1000,
            ...
            "high": 2500,
            "weight": 0.25,
            "description": "Lead, mercury, cadmium exposure in informal recycling"
        },
        "C3_environmental": {
            "dist": "lognormal",
            "low": 600,
            ...
            "high": 1600,
            "weight": 0.15,
            "description": "Soil/water contamination, ecosystem damage"
        },
        "C4_lost_materials": {
            "dist": "normal",
            "low": 45,
            ...
            "high": 80,
            "weight": 0.1,
            "description": "Unrecovered gold, copper, rare earths"
        },
        "C5_carbon": {
            "dist": "lognormal",
            "low": 400,
            ...
            "high": 1100,
            "weight": 0.12,
            "description": "Carbon cost of replacement manufacturing"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 250,
            ...
            "high": 700,
            "weight": 0.08,
            "description": "Basel Convention evasion, export displacement"
        }
    },
